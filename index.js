...
async function checkUpdate() {
    ...
    function getPackageVersion() {
        ...
        return new Promise((resolve, reject) => {
            exec(`npm view paginated.embed version`, (error, stdout, stderr) => {
    ...
    if(version.version) {
        if(version.version !== package.version) {
            console.log(`\x1b[34mPaginated.Embed is out of date!\x1b[0m Remember to use \x1b[32m"npm update paginated.embed" ( ${package.version} -> ${version.version} )\x1b[0m in powershell to take advantage of the new features.`)
        } else return;
    } else return;
